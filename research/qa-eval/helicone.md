...
status: active
local: partial
one_liner: "Open-source LLM observability platform — add one line (a proxy) to log, monitor, evaluate, cache, and cut cost across LLM calls. Self-host, or a free hosted tier."
...
| ⭐ / created | **5,996** ⭐ · created 2023-01 · TypeScript · active |
...
## 5. Sources
- https://github.com/Helicone/helicone (GitHub API: 5,996 ⭐, Apache-2.0, TypeScript, created 2023-01) · https://www.helicone.ai
