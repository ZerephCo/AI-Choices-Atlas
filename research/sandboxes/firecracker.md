...
- **Now (2026):** ⭐36k; the standard microVM primitive.
...
## 7. Hands-on
`docs-only` (2026-08-20). **TODO:** boot a Firecracker microVM with the jailer; run untrusted code inside.
