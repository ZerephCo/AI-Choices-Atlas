...
| ⭐ / created | 60,531 · 2023-08 · Python (+ .NET) |
...
- **Now (2026):** ⭐61k; ⚠️ maintenance mode.
...
## 8. Hands-on
`docs-only` (2026-08-20). **TODO:** try AutoGen Studio for a quick no-code multi-agent chat; but plan new work on MAF.

## 9. Sources
- https://github.com/microsoft/autogen (README) · microsoft.github.io/autogen · Microsoft Agent Framework docs

_Last updated: 2026-08-20 · verdict: ⚠️ maintenance mode · Researcher: Claude_
