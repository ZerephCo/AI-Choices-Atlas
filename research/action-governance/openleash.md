...
| Researched | 2026-08-20 · hands-on: **docs-only** · corpus-verified (Doc 28 §12.8 — "leading inspected sidecar"; 664 tests passed) |
...
## 7. Hands-on
`docs-only` (2026-08-20). **TODO:** set an owner policy; have an agent request an action; verify the signed proof as a counterparty.
