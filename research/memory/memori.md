...
| ⭐ / created | 15,633 · 2025-07-24 (pushed 2026-06-15) |
...
## 11. Hands-on
`docs-only` (2026-07-20). **TODO:** `pip install` + SQLite smoke (needs LLM key); **verify LICENSE terms**; inspect the Memory-Agent extraction + injection code.

## 12. Sources
- https://github.com/MemoriLabs/Memori (README) · https://gibsonai.github.io/memori/ (docs)
